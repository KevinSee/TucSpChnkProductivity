...
- [:file_folder: paper](/analysis/paper): Rmarkdown source document for
  manuscript. Includes code to reproduce the figures and tables
  generated by the analysis. It also has a rendered version,
  `Methods_Results.docx`, suitable for reading (the code is replaced by
...
`analysis/paper/Methods_Results.Rmd` and knit to produce the
`Methods_Results.docx`, or run
`rmarkdown::render("analysis/paper/Methods_Results.Rmd")` in the R
console
